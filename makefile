...
Compilator.exe: Compilator.y.tab.c Compilator.lex.yy.c src/symboltable.c src/tvartable.c src/conditionaljump.c src/write.c src/functable.c
	gcc Compilator.y.tab.c Compilator.lex.yy.c src/symboltable.c src/tvartable.c src/conditionaljump.c src/write.c -o Compilator.exe src/functable.c -std=c11 -Wall -Wextra -g
...
Compilator.y.tab.c: syntaxique_C_Return.y
	yacc -d syntaxique_C_Return.y -o Compilator.y.tab.c -v
...
clean:
	...
	mv -f Compilator.y.output ./make/Compilator.y.output 2>/dev/null
